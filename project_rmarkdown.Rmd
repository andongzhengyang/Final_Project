...
While collecting the data, we noticed variability in duration times for the same theoretical route at the same time of day, and we added one more research question:
...
After we saw the cost distribution is the strong right skew. We use the sqrt of cost to see if we can fit this in a normal distribution when we perform statistical analyses. But after we sqrt of the cost, it still looks right skew. 
...
##Time trend for Cost by Service
...
Explain decision-making process and then what the plot shows.

![](Plots/choicescheme_lyft.png)

This one shows just the opposite information, from the perspective of someone who wants Uber:

![](Plots/choicescheme_uber.png)

### Best Time of Morning/Evening to Travel
